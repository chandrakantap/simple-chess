...
@Component
public class BishopMoveValidator extends CommonMoveValidator{

    MoveResult validate(BoardCell fromCell, BoardCell toCell, Board board) {
        if(isValidLeftDiagonalMove(fromCell,toCell,board) || isValidRightDiagonalMove(fromCell,toCell,board)){
